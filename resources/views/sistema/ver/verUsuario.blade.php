...
<div class="row justify-content-center">
  <div class="mt-5 pt-5 col-sm-10">
    <div class="card">
        ...
        <div class="card-body">
            <form class="form" action="{{ route('sistema.salvarUsuario',['id' => $usuario->id]) }}" method="post">
                {{ csrf_field() }}
                Nome
        ...
        <div class="card-footer">
              <button class="btn btn-success mr-2" type="button" data-toggle="modal" data-target="#confirmarMudancas" name="button">Salvar mudanças</button><a href="{{ route('sistema.usuarios') }}" class="btn btn-primary mr-2">Cancelar</a><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#confirmarDelecaoUsuario">Apagar usuario</button>
            ...
            <form class="form" action="{{ route('sistema.deletarUsuario',['id' => $usuario->id]) }}" method="post">
              {{ csrf_field() }}
