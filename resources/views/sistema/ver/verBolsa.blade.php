...
<div class="row justify-content-center">
  <div class="mt-5 pt-5 col-sm-10 pb-5">
    <div class="card mb-5">
        ...
        <div class="card-body">
            <form class="form" action="{{ route('sistema.salvarBolsa',['id' => $bolsa->id]) }}" method="post">
                {{ csrf_field() }}
                Nome
                <div class="input-group mb-3">

                    <input id="campo-1" class="form-control" type="text" name="nome" value="{{ $bolsa->nome }}" readonly>
                ...
                <div class="input-group mb-3">
                    ...
                    <input id="campo-2" class="form-control" type="text" name="responsavel" value="{{ $bolsa->responsavel }}" readonly>
                    <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-3" class="form-control" type="text" name="email" value="{{ $bolsa->email }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-4" class="form-control" type="text" name="fone" value="{{ $bolsa->fone }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-5" class="form-control" type="text" name="rua" value="{{ $bolsa->rua }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-6" class="form-control" type="text" name="numero" value="{{ $bolsa->numero }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-7" class="form-control" type="text" name="bairro" value="{{ $bolsa->bairro }}" readonly>
                  <div class="input-group-append">
            ...
            <div id="confirmarDelecao" class="modal fade">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      <form action="{{ route('sistema.deletarBolsa',['id' => $bolsa->id]) }}" method="POST">{{ csrf_field() }}<button class="btn btn-success mr-2" type="submit" name="button" title="confirmar mudanças">Confirmar</button></form><button class="btn btn-danger" type="button" data-dismiss="modal" name="button" title="cancelar mudanças">Cancelar</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <h3 class="mt-5 mb-3">Lista de seções<a href="{{ route('sistema.adicionarSecao',['id' => $bolsa->id]) }}" class="btn btn-secondary mr-2 float-right" >Adicionar seção  <span class="fas fa-plus"></span> </a></h3>
    @if( !$secoes->isEmpty() )
    ...
    @else
      <div class="alert alert-info">
        Não há seções cadastrados
      </div>
    @endif
    <h3 class="mt-5 mb-3">Lista de documentos<a href="{{ route('sistema.adicionarDocumento',['id' => $bolsa->id]) }}" class="btn btn-secondary mr-2 float-right" >Adicionar documento  <span class="fas fa-plus"></span> </a></h3>
