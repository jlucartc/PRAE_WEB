...
<div class="row justify-content-center">
  <div class="mt-5 pt-5 col-sm-10 pb-5">
    <div class="card mb-5">
        ...
        <div class="card-body">
            <form class="form" action="{{ route('sistema.salvarServico',['id' => $servico->id]) }}" method="post">
                {{ csrf_field() }}
                Nome
                <div class="input-group mb-3">

                    <input id="campo-1" class="form-control" type="text" name="nome" value="{{ $servico->nome }}" readonly>
                ...
                <div class="input-group mb-3">
                    ...
                    <input id="campo-2" class="form-control" type="text" name="responsavel" value="{{ $servico->responsavel }}" readonly>
                    <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-3" class="form-control" type="text" name="email" value="{{ $servico->email }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-4" class="form-control" type="text" name="fone" value="{{ $servico->fone }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-5" class="form-control" type="text" name="rua" value="{{ $servico->rua }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-6" class="form-control" type="text" name="numero" value="{{ $servico->numero }}" readonly>
                  <div class="input-group-append">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="campo-7" class="form-control" type="text" name="bairro" value="{{ $servico->bairro }}" readonly>
                  <div class="input-group-append">
        ...
        <div class="card-footer">
            <button class="btn btn-success mr-2" type="button" data-toggle="modal" data-target="#confirmarMudancas" name="button" title="salvar mudanças">Salvar mudanças</button><a href="{{ route('sistema.servicos') }}" class="btn btn-primary mr-2" title="cancelar mudanças e voltar">Cancelar</a><button class="btn btn-danger" type="button" data-toggle="modal" data-target="#confirmarDelecao" name="button" title="apagar servico">Apagar servico</button>
            ...
            <div id="confirmarDelecao" class="modal fade">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      <form action="{{ route('sistema.deletarServico',['id' => $servico->id]) }}" method="POST">{{ csrf_field() }}<button class="btn btn-success mr-2" type="submit" name="button" title="confirmar mudanças">Confirmar</button></form><button class="btn btn-danger" type="button" data-dismiss="modal" name="button" title="cancelar mudanças">Cancelar</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <h3 class="mt-5 mb-3">Lista de seções<a href="{{ route('sistema.adicionarSecao',['id' => $servico->id]) }}" class="btn btn-secondary mr-2 float-right" >Adicionar seção  <span class="fas fa-plus"></span> </a></h3>
    @if( !$secoes->isEmpty() )
    ...
    @endif
    <h3 class="mt-5 mb-3">Lista de documentos<a href="{{ route('sistema.adicionarDocumento',['id' => $servico->id]) }}" class="btn btn-secondary mr-2 float-right" >Adicionar documento  <span class="fas fa-plus"></span> </a></h3>
