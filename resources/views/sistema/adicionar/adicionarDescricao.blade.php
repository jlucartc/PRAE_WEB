...
<div class="row justify-content-center">
  ...
  <div class="mt-5 pt-5 col-sm-10">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <form class="form" action="{{ route('sistema.confirmarCadastroDescricao') }}" method="post">
              {{ csrf_field() }}
      ...
      <div class="card-footer">
            <button class="btn btn-success mr-2" type="submit" name="button" title="salvar descrição" >Salvar descrição</button><a href="{{ route('sistema.verCategoria',['id' => $id]) }}" class="btn btn-primary" name="button" title="cancelar mudanças e voltar">Cancelar</a>
          </form>
      </div>
    </div>
  </div>
