...
<div class="row justify-content-center">
  <div class="mt-5 pt-5 col-sm-10">
    ...
    <div class="card">
      ...
      <div class="card-body">
          <form class="form" action="{{ route('sistema.confirmarCadastroItem') }}" method="post">
              {{ csrf_field() }}
      ...
      <div class="card-footer">
            <button class="btn btn-success mr-2" type="submit" name="button" title="salvar descrição" >Salvar item</button><a href="{{ route('sistema.verLista',['id' => $id]) }}" class="btn btn-primary"type="button" name="button" title="cancelar mudanças e voltar">Cancelar</a>
          </form>
      </div>
    </div>
  </div>
