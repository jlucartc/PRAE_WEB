...
<div class="row justify-content-center">
  <div class="mt-5 pt-5 col-sm-10">
      ...
      <div class="card">
        ...
        <div class="card-body">
            <form class="form" action="{{ route('sistema.confirmarCadastroDivisao') }}" method="post">
              {{ csrf_field() }}
        ...
        <div class="card-footer">
          <button type="submit" class="btn btn-success mr-2" name="button" title="confirmar cadastro">Cadastrar</button><a href="{{ route('sistema.verCoordenadoria',['id' => $id]) }}" class="btn btn-danger"name="button" title="cancelar cadastro">Cancelar</a>
          </form>
        </div>
      </div>
  </div>
